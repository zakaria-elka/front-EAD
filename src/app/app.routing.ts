...
export const routes: Routes = [
  {
    ...
    children: [
      {
        path: '', redirectTo: 'home/assistance', pathMatch: 'full', canActivate: [AuthGuard]
      },
      { path: 'home', loadChildren: 'app/+home/home.module#HomeModule', data: { pageTitle: 'Home' }, canActivate: [AuthGuard] },
      { path: 'missions', loadChildren: 'app/+missions/missions.module#MissionsModule', data: { pageTitle: 'Missions' }, canActivate: [AuthGuard] },
      { path: 'admin', loadChildren: 'app/+admin/admin.module#AdminModule', data: { pageTitle: 'Administration' }, canActivate: [AuthGuard] },
      { path: 'reporting', loadChildren: 'app/+reporting/reporting.module#ReportingModule', data: { pageTitle: 'Reporting' } }
