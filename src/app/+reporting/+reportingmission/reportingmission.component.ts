...
@Component({
  selector: 'app-reportingmission',
  templateUrl: './reportingmission.component.html',
  styleUrls: ['./reportingmission.component.css']
})
export class ReportingMissionComponent implements OnInit {
